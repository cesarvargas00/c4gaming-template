	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				...
				<span class="text">Seus dados</span>
			</h4>
		</div>	
		<div class="panel-body">
			<% if(model.config.description){ %><p class="description">Informe seus dados pessoais</p><% } %>
...
$(document).ready(function(){
	...
	if($(".payment-address").size() < 2)
	{
		$("#payment_address_exists_new").click();
	}
