 <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
  <fieldset>
    ...
    <div class="form-group">
      <label class="col-sm-12 text-uppercase" for="input-company"><?php echo $entry_company; ?></label>
      <div class="col-sm-12">
        <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 text-uppercase" for="input-address-1"><?php echo $entry_address_1; ?></label>
      <div class="col-sm-12">
    ...
    <div class="form-group">
      <label class="col-sm-12 text-uppercase" for="input-address-2"><?php echo $entry_address_2; ?></label>
      <div class="col-sm-12">
        <input type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-address-2" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 text-uppercase" for="input-city"><?php echo $entry_city; ?></label>
      <div class="col-sm-12">
    ...
    <div class="form-group required">
      <label class="col-sm-12 text-uppercase" for="input-postcode"><?php echo $entry_postcode; ?></label>
      <div class="col-sm-12">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="form-group required">
          <label class="col-sm-12 text-uppercase" for="input-country"><?php echo $entry_country; ?></label>
          <div class="col-sm-12">
      ...
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="form-group required">
          <label class="col-sm-12 text-uppercase" for="input-zone"><?php echo $entry_zone; ?></label>
          <div class="col-sm-12">
    ...
    <?php } ?>
    <div class="form-group">
      <label class="col-sm-12 text-uppercase"><?php echo $entry_default; ?></label>
      <div class="col-sm-12">
        <?php if ($default) { ?>
  ...
  <div class="buttons clearfix">
    <div class="pull-left"><a href="<?php echo $add; ?>" class="btn btn-border m-w-200 border-radius-large"><?php echo $button_new_address; ?></a></div>
    <div class="pull-right">
      <input type="submit" value="Salvar" class="btn btn-border m-w-200 border-radius-large" />
    </div>
  </div>
</form>
