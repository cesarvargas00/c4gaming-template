<div id="cart" class="pull-right cart">
  <a href="<?php echo $cart; ?>"><span id="cart-total" class="line-height-33" data-loading-text="<?php echo $text_loading; ?>">
  <i class="fa fa-shopping-cart font-size-17"></i>
  <span><?php echo $text_items; ?></span>
  </span></a>
  <ul class="dropdown-menu pull-right p-x-20 p-y-10 hidden">
